...
use Skywalker\Entrust\Contracts\EntrustUserInterface;
use Skywalker\Entrust\Traits\EntrustUserTrait;
use Illuminate\Cache\ArrayStore;
use Illuminate\Support\Facades\Config;
use Illuminate\Support\Facades\Cache;
use Skywalker\Entrust\Permission;
use Skywalker\Entrust\Role;
...
class EntrustUserTest extends TestCase
{
    ...
    public function testRoles()
    {
        ...
        |------------------------------------------------------------
        */
        $belongsToMany = m::mock(\Illuminate\Database\Eloquent\Relations\BelongsToMany::class);
        $belongsToMany = m::mock(\Illuminate\Database\Eloquent\Relations\BelongsToMany::class);
        $belongsToMany->shouldIgnoreMissing();
    ...
    public function testHasRole()
    {
        ...
        */
        ...
        $user->roles = new \Illuminate\Database\Eloquent\Collection([$roleA, $roleB]);
        ...
        */
        ...
        Cache::shouldReceive('tags->remember')->times(9)->andReturn(new \Illuminate\Database\Eloquent\Collection($user->roles));
    ...
    public function testCan()
    {
        ...
        */
        ...
        Cache::shouldReceive('tags->remember')->times(11)->andReturn(new \Illuminate\Database\Eloquent\Collection($user->roles));
    ...
    public function testCanWithPlaceholderSupport()
    {
        ...
        */
        ...
        $user = new HasRoleUser();
        $user->roles = new \Illuminate\Database\Eloquent\Collection([$role]);
        ...
        */
        ...
        Cache::shouldReceive('tags->remember')->times(6)->andReturn(new \Illuminate\Database\Eloquent\Collection($user->roles));
    ...
    public function testAbilityShouldReturnBoolean()
    {
        ...
        */
        ...
        Cache::shouldReceive('tags->remember')->times(32)->andReturn(new \Illuminate\Database\Eloquent\Collection($user->roles));
    ...
    public function testAbilityShouldAcceptStrings()
    {
        ...
        */
        ...
        Cache::shouldReceive('tags->remember')->times(8)->andReturn(new \Illuminate\Database\Eloquent\Collection($user->roles));
    ...
    public function testDetachAllRoles()
    {
        ...
        */
        ...
        $relationship = m::mock(\Illuminate\Database\Eloquent\Relations\BelongsToMany::class);
        $relationship->shouldIgnoreMissing();
    ...
    {
        $permMock = m::mock('Skywalker\Entrust\Permission');
    ...
    {
        $roleMock = m::mock('Skywalker\Entrust\Role');
...
class HasRoleUser implements EntrustUserInterface
{
    ...
    {
        $mock = m::mock(\Illuminate\Database\Eloquent\Relations\BelongsToMany::class);
